...
<template>
    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg">
        ...
        <div v-if="password" class="mt-4">
            ...
            <button @click="usePassword" class="w-full px-4 py-2 bg-blue-600 text-white font-semibold rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:focus:ring-offset-gray-800">
                {{ __('Use Password') }}
            </button>
        </div>
    </div>
